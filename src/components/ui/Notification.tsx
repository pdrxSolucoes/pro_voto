  ...
  return (
    <div className="fixed top-4 right-4 z-50 flex flex-col space-y-2 max-w-md">
      {notifications.map((notification) => (
        <div
          key={notification.id}
          className={`rounded-md shadow-md p-4 flex items-start space-x-3 ${getBackgroundColorByType(
            notification.type
        ...
        >
          ...
          <button
            ...
            className="flex-shrink-0 ml-auto text-gray-600 hover:text-gray-800"
            aria-label="Fechar"
          >
            <svg
...
function getBackgroundColorByType(type: NotificationType): string {
  switch (type) {
    case "info":
